var app = function () {
    ...
    class de {
        constructor({
            ...
            this.url = e, this.headers = t, this.cookieOptions = Object.assign(Object.assign({}, Y), r), this.fetch =
                ue(n)
        }
        ...
        signUpWithEmail(e, t, r = {}) {
            return le(this, void 0, void 0, (function* () {
                try {
                    ...
                    const i = yield K(this.fetch, `${this.url}/signup${s}`, {
                        email: e,
                        password: t,
                        data: r.data,
        ...
        signInWithEmail(e, t, r = {}) {
            return le(this, void 0, void 0, (function* () {
                try {
                    ...
                    r.redirectTo && (s += "&redirect_to=" + encodeURIComponent(r.redirectTo));
                    const i = yield K(this.fetch, `${this.url}/token${s}`, {
                        email: e,
                        password: t
                    }, {
                        headers: n
        ...
        signUpWithPhone(e, t, r = {}) {
            return le(this, void 0, void 0, (function* () {
                try {
                    const n = Object.assign({}, this.headers),
                        s = yield K(this.fetch, `${this.url}/signup`, {
                            phone: e,
                            password: t,
                            data: r.data,
                            gotrue_meta_security: {
            ...
            return le(this, void 0, void 0, (function* () {
                try {
                    const r = Object.assign({}, this.headers),
                        ...
                        s = yield K(this.fetch, `${this.url}/token${n}`, {
                            phone: e,
                            password: t
                        }, {
                            headers: r
            ...
            return le(this, void 0, void 0, (function* () {
                try {
                    const i = Object.assign({}, this.headers),
                        ...
                        a = yield K(this.fetch, `${this.url}/token${o}`, {
                            id_token: e,
                            nonce: t,
                            client_id: r,
                            issuer: n,
        ...
        sendMagicLinkEmail(e, t = {}) {
            ...
            return le(this, void 0, void 0, (function* () {
                try {
                    ...
                    return {
                        data: yield K(this.fetch, `${this.url}/otp${s}`, {
                            email: e,
                            create_user: i,
                            gotrue_meta_security: {
        ...
        sendMobileOTP(e, t = {}) {
            ...
            return le(this, void 0, void 0, (function* () {
                try {
                    ...
                    return {
                        data: yield K(this.fetch, `${this.url}/otp`, {
                            phone: e,
                            create_user: n,
                            gotrue_meta_security: {
                                hcaptcha_token: t.captchaToken
        ...
        signOut(e) {
            return le(this, void 0, void 0, (function* () {
                try {
                    return yield K(this.fetch, `${this.url}/logout`, {}, {
        ...
        verifyMobileOTP(e, t, r = {}) {
            return le(this, void 0, void 0, (function* () {
                try {
                    const n = Object.assign({}, this.headers),
                        s = yield K(this.fetch, `${this.url}/verify`, {
                            phone: e,
                            token: t,
                            type: "sms",
        ...
        verifyOTP({
            ...
            return le(this, void 0, void 0, (function* () {
                try {
                    const i = Object.assign({}, this.headers),
                        o = yield K(this.fetch, `${this.url}/verify`, {
                            email: e,
                            phone: t,
                            token: r,
                            type: n,
        ...
        inviteUserByEmail(e, t = {}) {
            return le(this, void 0, void 0, (function* () {
                try {
                    ...
                    return {
                        data: yield K(this.fetch, `${this.url}/invite${n}`, {
                            email: e,
                            data: t.data
                        }, {
                            headers: r
        ...
        resetPasswordForEmail(e, t = {}) {
            return le(this, void 0, void 0, (function* () {
                try {
                    ...
                    t.redirectTo && (n += "?redirect_to=" + encodeURIComponent(t.redirectTo));
                    return {
                        data: yield K(this.fetch, `${this.url}/recover${n}`, {
                            email: e,
                            gotrue_meta_security: {
                                hcaptcha_token: t.captchaToken
                            }
        ...
        refreshAccessToken(e) {
            return le(this, void 0, void 0, (function* () {
                try {
                    const t = yield K(this.fetch, `${this.url}/token?grant_type=refresh_token`, {
                        refresh_token: e
                    }, {
        ...
        generateLink(e, t, r = {}) {
            return le(this, void 0, void 0, (function* () {
                try {
                    return {
                        data: yield K(this.fetch, `${this.url}/admin/generate_link`, {
                            type: e,
                            email: t,
                            password: r.password,
                            data: r.data,
    ...
    class me extends class {
        ...
        _recoverSession() {
            var e;
            try {
                const t = he() && (null === (e = this.localStorage) || void 0 === e ? void 0 : e.getItem(X));
        ...
        constructor(e, t = {}, r) {
            this.topic = e, this.params = t, this.socket = r, this.bindings = [], this.state = Je.closed, this.joinedOnce = !
                1, this.pushBuffer = [], this.timeout = this.socket.timeout, this.joinPush = new We(this, Ge.join,
                    this.params, this.timeout), this.rejoinTimer = new ze((() => this.rejoinUntilConnected()),
    ...
    class Xe {
        constructor(e, t) {
            ...
            this.channel.on(r.state, {}, (e => {
                ...
                this.joinRef = this.channel.joinRef(), this.state = Xe.syncState(this.state, e, t,
                ...
                this.inPendingSyncState() ? this.pendingDiffs.push(e) : (this.state = Xe.syncDiff(
                    this.state, e, t, r), n())
            }))
        }
    ...
    class Ye {
        ...
        off(e, t) {
            this.bindings = this.bindings.filter((r => !(r.type === e && Ye.isEqual(r.eventFilter, t))))
        }
        canPush() {
            return this.socket.isConnected() && this.isJoined()
        }
    ...
    class tt {
        constructor(e, t) {
            this.accessToken = null, this.channels = [], this.endPoint = "", this.headers = Fe, this.params = {},
                ...
                et, this.conn = null, this.sendBuffer = [], this.serializer = new Ke, this.stateChangeCallbacks = {
                    open: [],
                    close: [],
                    error: [],
                    message: []
                ...
                new ze((() => Qe(this, void 0, void 0, (function* () {
        ...
        channel(e, t = {
            ...
            const {
                isNewVersion: r
            } = t, n = Ze(t, ["isNewVersion"]), s = r ? new Ye(e, Object.assign({}, n), this) : new Ve(e,
                Object.assign({}, n), this);
            return s instanceof Ye && (s.presence.onJoin(((e, t, r) => {
                s.trigger("presence", {
                    event: "JOIN",
                    key: e,
                    currentPresences: t,
        ...
        return {
            ...
            p(e, t) {
                8 & t && !c(n.src, s = `data:image/svg+xml;utf8,${Gt(e[4].email||e[4].name)}`) && y(n, "src", s), 8 &
                    t && E !== (E = e[4].name + "") && b(h, E), 8 & t && O !== (O = Vt(e[4].created_at, "zh") + "") &&
    ...
    function Wt(t) {
        let r, n, i, o, a, h, c, u, m, b, w, k, T, $, E, O, S, x, j, P, A, R = t[0] && zt(),
            U = t[3],
            C = [];
        ...
        return {
            c() {
                r = p("div"), n = p("div"), i = p("div"), o = p("input"), a = g(), h = p("div"), c = p("input"), u =
                    ...
                    '<p class="text-gray-400 h-5">提交</p>', $ = g(), E = p("p"), E.textContent =
                    "*如需回复, 请填写邮箱或其他有效联系方式.", O = g(), S = p("div"), x = p("div"), R && R.c(), j = g();
            ...
            p(e, [t]) {
                if (2 & t && o.value !== e[1] && _(o, e[1]), 4 & t && c.value !== e[2] && _(c, e[2]), 16 & t && _(b,
                        e[4]), e[0] ? R || (R = zt(), R.c(), R.m(x, j)) : R && (R.d(1), R = null), 8 & t) {
                    let r;
    ...
    function Qt(t) {
        ...
        return {
            c() {
                r = p("h1"), r.textContent = "data-url 配置错误", y(r, "class", "text-6xl text-red-500 p-5")
            },
            m(e, t) {
                d(e, r, t)
            },
